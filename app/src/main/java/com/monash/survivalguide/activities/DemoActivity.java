...
import com.monash.survivalguide.entities.Demo;
import com.monash.survivalguide.fragments.ItemFragment;
import com.ogaclejapan.smarttablayout.SmartTabLayout;
import com.ogaclejapan.smarttablayout.utils.v4.FragmentPagerItem;
import com.ogaclejapan.smarttablayout.utils.v4.FragmentPagerItemAdapter;
import com.ogaclejapan.smarttablayout.utils.v4.FragmentPagerItems;

public class DemoActivity extends ActionBarActivity implements ItemFragment.ItemFragmentCallbacks {
...
//    demo.setup(viewPagerTab);
    ...
    for (int titleResId : demo.tabs()) {
      pages.add(FragmentPagerItem.of(getString(titleResId), ItemFragment.class));
    }
