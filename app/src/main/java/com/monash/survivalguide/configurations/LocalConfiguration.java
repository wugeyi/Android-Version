...
import com.monash.survivalguide.entities.AppTheme;
...
public class LocalConfiguration {
    ...
    //at home
//    public static String[] IPs = {"192","168","0","11"};
    //at uni
//	public static String[] IPs = {"118","139","46","229"};

    public static String[] IPs = {"119", "9", "21", "73"};
    ...
    public final static int CONTENT_TEXT_MAX_LENGTH = 500;
    public final static int CONTENT_TEXT_MAX_LENGTH_MINUS_ONE = 499;
