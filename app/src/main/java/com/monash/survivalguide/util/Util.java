package com.monash.survivalguide.util;
...
public class Util {
    ...
    public static String dateFormTransfer(Date serverDate, Context context) {
        Time t = new Time();
        t.setToNow();
        int year = t.year;
        int month = t.month;
        ...
        int minute = t.minute;
        int second = t.second;
//        Log.e("","--"+serverDate.toString());
//        Log.e("","--"+(serverDate.getYear()+1900));
//        Log.e("","--"+(serverDate.getMonth()+1));
//        Log.e("","--"+serverDate.getDate());
//        Log.e("","--"+serverDate.getHours());
//        Log.e("","--"+serverDate.getMinutes());
//        Log.e("","--"+serverDate.getSeconds());
        try {
            int serverYear = serverDate.getYear()+1900;
            int serverMonth = serverDate.getMonth();
            int serverDay = serverDate.getDate();
            int serverHour = serverDate.getHours();
            int serverMinute = serverDate.getMinutes();
            int serverSecond = serverDate.getSeconds();
