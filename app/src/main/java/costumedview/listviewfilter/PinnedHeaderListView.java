...
package costumedview.listviewfilter;
...
public class PinnedHeaderListView extends ListView implements IIndexBarFilter
{
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) 
    {
    	...
    	if (mIndexBarView != null && IS_INDEX_BAR_VIEW_VISIBLE) 
    	{
    		mIndexBarView.layout(getMeasuredWidth()- mIndexBarViewMargin - mIndexBarViewWidth, mIndexBarViewMargin+30
    				, getMeasuredWidth()- mIndexBarViewMargin, getMeasuredHeight()- mIndexBarViewMargin+20);
        }
