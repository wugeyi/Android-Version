...
public class FloatingActionButton extends ImageButton {
    ...
    public interface OnFragmentLoadMoreListener {
        public void onFragmentLoadMore();
    }

    private OnFragmentLoadMoreListener mListener;
    public void setLoadMoreInterface(Fragment f)
    {
        mListener = (OnFragmentLoadMoreListener)f;
    }
    @Override
...
//            Log.e("", "totalItemCount:"+totalItemCount+", AUTOLOAD_THRESHOLD:"+AUTOLOAD_THRESHOLD + ", firstVisibleItem:"+firstVisibleItem+", visibleItemCount:"+visibleItemCount);
                if (totalItemCount - AUTOLOAD_THRESHOLD <= firstVisibleItem + visibleItemCount && mListener!=null) {
                    mListener.onFragmentLoadMore();
                }
